...
export const getAllShoppingList = (query) => ShoppingListAction.getAllData(query)
export const getOneShoppingList = (id) => ShoppingListAction.getOneData(id)
export const createOneShoppingList = (data) => ShoppingListAction.createOne(data)
export const updateOneShoppingList = (id, payload) => ShoppingListAction.editOne(id, payload)
